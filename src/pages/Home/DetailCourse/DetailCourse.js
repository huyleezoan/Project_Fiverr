...
export default function DetailCourse(props) {
  ...
  useEffect(() => {
    ...
    console.log("course: ", detailCourse);
  }, []);
  //   useEffect(() => {
  //     setDetailPerson(http.get(`/api/users/${detailCourse?.userCreated}`));
  //   }, [detailCourse]);
  //   console.log("detail: ", detailPerson);
  // useEffect(() => {
  //   setDetailPerson(http.get(`/api/users/${detailCourse.userCreated}`));
  // }, [detailPerson]);
  // console.log(detailCourse);
  // useEffect(() => {
  //   setDetailPerson(http.get(`/api/users/${detailCourse.userCreated}`).data);
  // }, [detailPerson]);
        ...
        <div className="col-8">
          ...
          <div>
            ...
            <button classname="btn">
              <a href="#seller" classname="text-primary"></a>
            </button>
          ...
          <p className="mt-4">
            I am a full time Wix web site designer/developer. I have 4+ years of
            website designing experience using Wix platform. Being a Wix
            specialist, I have worked with numerous clients to help with
            developing clean, modern and elegant websites to fulfill their
            requirements.
          </p>
          <div className="ml-2">
            <p>
              I am a full time Wix web site designer/developer. I have 4+ years
              of website designing experience using Wix platform. Being a Wix
              specialist, I have worked with numerous clients to help with
              developing clean, modern and elegant websites to fulfill their
              requirements.
            </p>
            ...
            <p>
              <strong>
                <u>&nbsp;What I can do for you in WIX:</u>
              </strong>
            </p>
            <p>
              <br />
            ...
            <ul>
              <li>Design a WIX site from scratch</li>
            ...
            <p>
              <strong>
                <u>Why choosing me will be the right choice</u>
              </strong>
            </p>
            <p>
              <br />
            ...
            <ul>
              <li>100% genuine and professional work</li>
            ...
            <p>
              <strong>
                <u>
                  If something is not included in my packages or extra's, please
                  message prior
                </u>
              </strong>
            </p>
        ...
        <div className="col-4">
          <nav className="text-center">
            <div className="nav nav-tabs" id="nav-tab" role="tablist">
              <a
                className="nav-link nav-cus active col-4"
                id="nav-home-tab"
                data-toggle="tab"
                href="#nav-home"
                role="tab"
              ...
              <a
                className="nav-link nav-cus col-4"
                id="nav-profile-tab"
                data-toggle="tab"
                href="#nav-profile"
                role="tab"
